> ⚠⚠ **SUPERSEDED 2026-09-08 by `SPEC.md`.** This is the 2026-08-30 brief, kept verbatim
> because decisions were taken against it and a reversed decision keeps its record. It is
> NOT the acceptance criteria any more. What changed: the named SMS provider is out and
> replaced by a research gate · analytics is back (9 events) · the OTP routes are renamed ·
> new state enums · a preservation contract · a design-token requirement. See `SPEC.md` §0.
